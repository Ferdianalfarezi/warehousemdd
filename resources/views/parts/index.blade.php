...
<div class="space-y-6">
  ...
  <div class="flex flex-col md:flex-row md:items-center md:justify-start md:space-x-4 space-y-3 md:space-y-0">
    ...
    <!-- Per Page Selector dengan padding lebih -->
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <tbody class="divide-y divide-gray-200" id="partsTableBody">
                    ...
                    @forelse($parts as $index => $part)
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="px-6 py-4">
                                @if($part->gambar)
                                    <img src="{{ asset('storage/parts/'.$part->gambar) }}" 
                                        onclick="showImagePreview('{{ asset('storage/parts/'.$part->gambar) }}', '{{ $part->nama }}')"
        ...
        <!-- Footer: Showing Entries + Per Page (di bawah tabel) -->
    ...
    async function openEditModal(id) {
        try {
            ...
            if (data.success) {
                ...
                if (part.gambar) {
                    const imagePath = `/storage/parts/${part.gambar}`;
