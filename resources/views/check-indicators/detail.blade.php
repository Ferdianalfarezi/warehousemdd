    ...
    async function viewDetails(id) {
        try {
            ...
            if (data.success) {
                ...
                (indicator.standards || []).forEach((std, index) => {
                    standardsHTML += `
                        <tr class="border-b border-gray-200">
                            ...
                            <td class="px-4 py-3 text-sm text-gray-600 whitespace-pre-line">${std.standar}</td>
                        </tr>
                    `;
                });
                    ...
                    <div>
                        ...
                        <div class="overflow-x-auto border border-gray-200 rounded-lg">
                            <table class="w-full">
                                ...
                                <tbody>
                                    ${standardsHTML || '<tr><td colspan="4" class="px-4 py-8 text-center text-gray-500">Tidak ada poin pemeriksaan</td></tr>'}
                                </tbody>
                            </table>
                        </div>
                    </div>
                ...
                Swal.fire('Error!', data.message || 'Gagal memuat detail indicator', 'error');
            }
        } catch (error) {
