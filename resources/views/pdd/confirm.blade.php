...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-3xl font-bold text-gray-900">Konfirmasi Permintaan Inhouse</h1>
            <p class="text-gray-600 mt-1">Review dan approve permintaan perbaikan inhouse</p>
        </div>
    </div>
...
<div id="detailModal" class="hidden fixed inset-0 bg-black bg-opacity-50 z-50 items-center justify-center p-4">
    <div class="bg-white rounded-2xl shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div class="sticky top-0 bg-white border-b border-gray-200 px-6 py-4 rounded-t-2xl">
            <div class="flex items-center justify-between">
                <h2 class="text-2xl font-bold text-gray-900">Detail Permintaan Inhouse</h2>
        ...
        <div class="p-6 space-y-4">
            ...
            <div>
                <p class="text-xs text-gray-500">Proses yang Dilakukan</p>
                <p id="detailProses" class="text-sm text-gray-700 bg-gray-50 p-3 rounded-lg">-</p>
            </div>
            <div>
...
async function openDetailModal(requestId) {
    try {
        const response = await fetch(`/pdd/confirm/${requestId}`);
...
async function approveRequest(requestId) {
    ...
    try {
        const response = await fetch(`/pdd/confirm/${requestId}/approve`, {
            method: 'POST',
            headers: {
