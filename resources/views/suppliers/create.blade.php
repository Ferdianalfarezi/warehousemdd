<!-- CREATE Modal -->
<div id="createModal" class="fixed inset-0 hidden items-center justify-center z-50">
    <div class="bg-white rounded-2xl shadow-2xl w-full max-w-md mx-4 transform transition-all">
        <!-- Modal Header -->
        <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200">
            <h2 class="text-xl font-bold text-gray-900">Add Supplier</h2>
        ...
        <form id="createForm" class="p-6 space-y-4">
            ...
            <!-- Nama Supplier -->
            <div>
                <label for="createNama" class="block text-sm font-semibold text-gray-700 mb-2">Nama Supplier</label>
                <input 
                    type="text" 
                    id="createNama" 
                    name="nama" 
            ...
            <!-- Alamat -->
            <div>
                <label for="createAlamat" class="block text-sm font-semibold text-gray-700 mb-2">Alamat</label>
                <textarea 
                    id="createAlamat" 
                    name="alamat" 
                    rows="4" 
                ...
                ></textarea>
                <span class="text-red-500 text-sm error-message" id="error-create-alamat"></span>
            </div>
